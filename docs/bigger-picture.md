...
The price leveraging Web-scale infrastructure is the investment of having members of the interdisciplinary DevOps team gain experience with these  building blocks, services and practices.  The team has to be provided the *adaptive capacity*, to borrow from Cadieux's term, to explore how to exploit the technologies to the benefit of the B2B ISV. Hands-on experience is needed to work through the hard realities of making system change, deployment and management a predictable, efficient and largely automate process.
